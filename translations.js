/** PAGE: translations.js | VERSION: 1.9.8 */
/** * DESCRIPTION: Dictionnaire global centralisé. */
...
const DJUNTA_TRANSLATIONS = {
    fr: {
        ...
        "pwa_desc": "Ajoutez l'application à votre écran d'accueil.",
        "pwa_ios_guide": "Appuyez sur 'Partager' [icon] puis 'Sur l'écran d'accueil'.",
        "pwa_btn_install": "Installer", "pwa_btn_close": "Plus tard",
    ...
    en: {
        ...
        "pwa_title": "Install DjuntaCar", "pwa_desc": "Add to home screen.",
    ...
    pt: {
        ...
        "pwa_title": "Instalar DjuntaCar", "pwa_desc": "Adicione à tela inicial.",
